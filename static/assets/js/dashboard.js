  ...
  new Chart(marketingOverviewCanvas, {
    ...
    plugins: [{
      afterDatasetUpdate: function(chart) {
        ...
        // Clear existing legend to avoid duplication
        ...
        chart.data.datasets.forEach(function(dataset) {
          ...
          const color = dataset.backgroundColor; // Use background color instead of borderColor
    ...
    plugins: [{
      afterDatasetUpdate: function(chart) {
        ...
        chart.data.datasets[0].data.forEach(function(value, i) {
          ul.innerHTML += `
            <li style="list-style: none; margin-bottom: 10px;">
              <span style="display:inline-block; width: 12px; height: 12px; background-color: ${chart.data.datasets[0].backgroundColor[i]}; margin-right: 5px;"></span>
              ${chart.data.labels[i]}
            </li>
          `;
        });
